...
export default function ServersSlider() {
  ...
  return (
    <section id="servers" className="relative z-10 py-20 px-6 border-t border-white/10 overflow-hidden">
        ...
        <div className="relative w-full overflow-hidden py-8">
          ...
          >
            {doubledServers.map((server, index) => (
              ...
              >
                <div className="bg-white/5 border border-white/20 rounded-2xl p-8 hover:border-white/50 transition-all h-48 flex flex-col justify-center items-center text-center group cursor-pointer hover:shadow-xl hover:shadow-white/30">
                  <h3 className="text-2xl font-bold mb-3 text-white group-hover:text-white transition">{server.name}</h3>
                  <div className="w-12 h-1 bg-white rounded-full mb-3 group-hover:w-16 transition-all"></div>
